...
NIFTY50_TICKERS = [
    ...
    "APOLLOHOSP.NS", "DIVISLAB.NS", "LTIM.NS", "SBILIFE.NS", "HDFCLIFE.NS",
    "TATACONSUM.NS", "BAJAJ-AUTO.NS", "SHRIRAMFIN.NS", "TATASTEEL.NS", "BEL.NS",
]

NIFTY_NEXT50_TICKERS = [
    "ABB.NS", "ADANIENSOL.NS", "ADANIENT.NS", "ADANIGREEN.NS", "ADANITRANS.NS",
    ...
    "JINDALSTEL.NS", "LICI.NS", "LUPIN.NS", "MCDOWELL-N.NS", "MPHASIS.NS",
    "NAUKRI.NS", "NMDC.NS", "OBEROIRLTY.NS", "PERSISTENT.NS", "PETRONET.NS",
    "PIIND.NS", "PNB.NS", "SBICARD.NS", "SIEMENS.NS", "TATACOMM.NS",
